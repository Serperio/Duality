...
public class SpriteSwap : MonoBehaviour
{
    ...
    // The name of the sprite sheet to use
    public string SpriteSheetName = "I";
    ...
    private void LateUpdate()
    {
        ...
        if (this.LoadedSpriteSheetName != this.SpriteSheetName || this.LoadedFolder != this.Folder)
        {
    ...
    private void LoadSpriteSheet()
    {
        ...
        var sprites = Resources.LoadAll<Sprite>(this.Folder + "/" + this.SpriteSheetName);
